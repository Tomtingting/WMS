...
<form name="frm2"   action="zjpandianprint.php" method="post" enctype="multipart/form-data">
...
<div id="result" style="">
    ...
    <table id="tb">
        ...
        $page=$_GET['page'];
        $sql="select * from tbzjzk where Count>0";
        ...
        $sql_p = "select * from tbzjzk where Count>0 LIMIT ".$my_page->page_limit.",".$my_page->myde_size;
